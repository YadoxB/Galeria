    ...
    <div class="vue-fiche">
      ...
      <form id="formulaire" class="formulaire" novalidate>
        ${blocPliable('La galerie', `
          ...
          <p class="aide-champ">Ces informations alimentent les bas de page, les en-têtes et les blocs de coordonnées de tous les documents générés.</p>
        `)}
