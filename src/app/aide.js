...
const ARTICLES = [
  ...
  A('depannage', 'Pourquoi certaines œuvres sont-elles grisées ?', 'grisé grisée grisées estompé estompée pâle opacité retirée retirées archive badge inclure',
    `<p>Une œuvre affichée en <b>grisé</b> avec un badge <b>« Retirée »</b> a été <b>retirée du catalogue actif</b> (rendue à l'artiste). Elle reste visible uniquement parce que l'option <b>« Inclure les retirées »</b> est cochée dans les Filtres.</p>
     <ul><li><b>Pour les masquer</b> : ouvre les <b>Filtres</b> et décoche « Inclure les retirées ».</li>
     <li><b>Pour en remettre une au catalogue</b> : ouvre sa fiche → <b>Réintégrer</b> (le grisé et le badge disparaissent).</li></ul>
     <p>Autre cas : en <b>mode sélection</b> (bouton « Retirer »), les œuvres <b>vendues</b> et celles déjà retirées s'affichent grisées car elles ne peuvent pas être sélectionnées.</p>
     <div class="voir-aussi"><b>Voir aussi :</b> <a data-go="Retirer une œuvre (la rendre à l'artiste)">Retirer une œuvre</a></div>`),
