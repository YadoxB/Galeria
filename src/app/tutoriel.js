...
const ETAPES = [
  ...
  { vue: 'ventes-liste', cible: '.entree-sidebar[data-vue="ventes-liste"]', placement: 'right', titre: 'Ventes & clients', texte: "Enregistrez une <b>vente</b> (œuvre + client, taxes, rabais). Le suivi des commandes se fait dans <b>Suivi</b>." },
