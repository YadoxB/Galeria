...
const ETAPES = [
  ...
  { vue: 'suivi', cible: '.entree-sidebar[data-vue="suivi"]', placement: 'right', titre: 'Le suivi des commandes', texte: "Le <b>Suivi</b> regroupe les œuvres à préparer (Sage, stock, site) et les commandes en cours — <b>paiement, emballage, envoi, livraison</b>, puis les tâches de la galerie (<b>Sage, Google, artiste payé</b>) — éditables d'un clic." },
