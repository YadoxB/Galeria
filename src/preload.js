...
contextBridge.exposeInMainWorld('api', {
  ...
  iaTraduire: (params) => ipcRenderer.invoke('ia:traduire', params),
  ...
  pdfPochetteGenerer: (venteId, options) => ipcRenderer.invoke('pdf:pochette-generer', venteId, options),
  ...
  soutienRapport: (options) => ipcRenderer.invoke('soutien:rapport', options),
  soutienEnregistrerRapport: (texte) => ipcRenderer.invoke('soutien:enregistrer-rapport', texte),
  soutienApercu: () => ipcRenderer.invoke('soutien:apercu'),
  soutienProduire: (options) => ipcRenderer.invoke('soutien:produire', options),
